...
from IMDLBenCo.evaluation import PixelF1, PixelAUC
...
def get_args_parser():
    ...
    parser.add_argument('--if_predict_label', action='store_true', default=True,
    ...
    parser.add_argument('--data_path', default='./XXX/XXX.json', type=str,
                        help='dataset path, should be our json_dataset or mani_dataset format. Details are in readme.md')
    parser.add_argument('--test_data_path', default='./XXX/XXX.json', type=str,
    ...
    # Test related
    parser.add_argument('--no_model_eval', action='store_false',default=False,
                        help='Do not use model.eval() during testing.')
    parser.add_argument('--test_period', default=2, type=int,
