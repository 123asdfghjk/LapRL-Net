...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.conv_1x1_merge = nn.Sequential(
            nn.Conv2d(128, 64, kernel_size=1, stride=1, bias=False, groups=2),
            nn.BatchNorm2d(64),
        ...
        last_inp_channels = np.sum(pre_stage_channels)
